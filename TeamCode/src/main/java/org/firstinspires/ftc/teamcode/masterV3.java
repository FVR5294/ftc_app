...
public class masterV3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (ask("Default Starting Position", "Alternate Starting Position")) {
            ...
            if (ask("Drive forward first", "Strafe First")) {
            ...
            if (ask("Center Vortex Ending", "Corner Vortex Ending")) {
                ...
                if (ask("Just pivot", "Pivot then spin")) {
                    askState(states.pivotbeaconmore);
                } else {
                    askState(states.pivotbeacon, states.pivotbeaconless);
                    if (ask("Use Gyro", "Don't use Gyro")) {
                        askState(states.rotate45);
                    } else {
